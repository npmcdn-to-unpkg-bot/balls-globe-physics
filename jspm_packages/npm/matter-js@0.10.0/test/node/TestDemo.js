...
(function(process) {
  ...
  var $ = require('cheerio');
  var Matter = require('../../build/matter-dev');
  Matter.Example = require('../../demo/js/Examples');
  Matter.Demo = require('../../demo/js/Demo');
  var demo,
      frames = 10,
  ...
  var getDemoNames = function() {
    var demos = [],
        skip = ['terrain', 'svg', 'concave', 'slingshot', 'views', 'raycasting', 'events', 'collisionFiltering', 'sleeping'];
    $('#demo-select option', fs.readFileSync('demo/index.html').toString()).each(function() {
      var name = $(this).val();
